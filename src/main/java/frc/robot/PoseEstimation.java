...
public class PoseEstimation {
    ...
    public PoseEstimation(Drive drive) {
        ...
        // Creates the odometry tracker and starts is at (0, 0)
        ...
        // Trusts encoders more than the AprilTags, NEVER trusts the AprilTags rotation values
    ...
    ******************************************************************************************/
     ...
     * 
     * BROKEN With new LimelightHelpers file
     */
